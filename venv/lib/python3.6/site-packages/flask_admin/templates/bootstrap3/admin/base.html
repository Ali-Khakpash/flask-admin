...
<html>
  <head>
    ...
    {% block head_css %}
        ...
        <link href="{{ admin_static.url(filename='admin/css/bootstrap4/bootstrap.min.css', v='4.0.0') }}" rel="stylesheet">
  ...
  <body>
    ...
    <div class="container{%if config.get('FLASK_ADMIN_FLUID_LAYOUT', False) %}-fluid{% endif %}">
      <nav class="navbar navbar-default" role="navigation">
        ...
        <!-- navbar content -->
        <div class="collapse navbar-collapse" id="admin-navbar-collapse"  style="float: left !important;">
          {% block main_menu %}
          <ul class="nav navbar-nav" style="display:inline-block !important; ">
            {{ layout.menu() }}
          </ul>
          {% endblock %}
          <a class="navbar-brand float-right mt-3" href="{{ admin_view.admin.url }}">{{ admin_view.admin.name }}</a>
    ...
    <!-- custom propper.js   -->
    <script src="{{ admin_static.url(filename='admin/js/propper.js', v='1.12.9') }}" type="text/javascript"></script>
    <!-- custom bootstrap.min.js   -->
    <script src="{{ admin_static.url(filename='admin/js/bootstrap4/bootstrap.min.js', v='4.0.0') }}" type="text/javascript"></script>
